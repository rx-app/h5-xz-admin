<template>
  <div class="about card">
    ...
    <el-form style="max-width:600px" label-width="120px" @submit.native.prevent="save">
      ...
      <el-form-item label="内容" class="editor-el-form-item__content">
        <vue-editor v-model="model.content" :editor-toolbar="customToolbar" useCustomImageHandler @imageAdded="handleImageAdded"></vue-editor>
      </el-form-item>
